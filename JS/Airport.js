...
class Airport {
    ...
    sortByMaxDistance() {
        this.planes.sort((planeA, planeB) => (planeA.getMaxFlightDistance() - planeB.getMaxFlightDistance()));
        return this;
    }

    sortByMaxSpeed() {
        this.planes.sort((planeA, planeB) => (planeA.getMaxSpees() - planeB.getMaxSpees()));
        return this;
    }

    sortByMaxLoadCapacity() {
        this.planes.sort((planeA, planeB) => (planeA.getMaxLoadCapacity() - planeB.getMaxLoadCapacity()));
        return this;
    }
